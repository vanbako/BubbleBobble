...
GameObject* Level::CreateLevel(int level, Minigin* pEngine, Scene* pScene, BufferManager* pBufferManager, GameObject** ppGOBubbles, HudComponent* pHudComponent)
{
	...
	pGOLevel->CreateModelComponent<LevelComponent>(pEngine, pBufferManager, pLevelPalette, pLayout, ppGOBubbles, pHudComponent);
